...
c.InteractiveShellApp.exec_lines = ['%load_ext sql',
                                    '%load_ext autoreload',
                                    '%autoreload 2',
...
# Configure matplotlib inlineBackend rc params
c.InlineBackend.rc = {'font.family': 'serif',
...
c.InteractiveShellApp.extensions = ['d3js_magic', 'processing_magic']
...
c.InteractiveShellApp.exec_files = ['start.ipy']
...
# c.TerminalInteractiveShell.editor = u'emacs -q'

# Deprecated, use PromptManager.justify
# c.TerminalInteractiveShell.prompts_pad_left = True

# The part of the banner to be printed before the profile
# c.TerminalInteractiveShell.banner1 = 'Python 2.7.8 (default, Oct 14 2014, 16:55:15) \nType "copyright", "credits" or "license" for more information.\n\nIPython 3.0.0-b1 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# script_paths
# c.ScriptMagics.script_magics = ['sql']
